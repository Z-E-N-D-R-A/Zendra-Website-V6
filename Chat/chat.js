...
<body>
  ...
  <div class="chat-wrapper">
    <button id="toggleSidebar" class="sidebar-toggle">
      <div class="fa-solid fas fa-grip-horizontal"></div>
    </button>
    ...
    <main class="chat-area">
      <div id="newMsgIndicator" class="new-msg-indicator hidden">New messages</div>
      <div class="messages-scroll">
        <button id="loadOlderBtn" class="load-more">Load older messages</button>
        <div id="loadingOlder" class="loading-indicator">Loading…</div>
        <div id="messages"></div>
      </div>
      ...
      <div class="input-bar">
        <textarea id="messageInput" contenteditable="true" placeholder="Type a message…"></textarea>
